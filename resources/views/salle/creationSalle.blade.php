...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header bg-outline-dark btn-lg btn-block font-weight-bold justify-content-center" style="font-size: 150%"> <i class="far fa-plus-square"></i>  Ajouter une Salle de sport</div>
                    <div class="card-body">
