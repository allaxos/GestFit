            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class=”panel-heading” style="margin: 1%;"><a href="#" class="btn btn-outline-dark btn-lg btn-block font-weight-bold" style="font-size: 150%;"><i class="fas fa-hand-peace"></i> Mes réservations</a></div>
                    </div>
                </div>
            </div>
        </div>
