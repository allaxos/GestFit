            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class=”panel-heading” style="margin: 1%;"><a href="{{route('salle.index')}}" class="btn btn-outline-success btn-lg btn-block font-weight-bold" style="font-size: 200%;"><i class="fas fa-warehouse"></i> Mes salles</a></div>
