                ...
                <div class="col-sm-6" >
                    <div class="card" style="padding: 2%;margin: 2% 0%; box-shadow: 5px 5px 10px">
                        <div class="card-body">
                            ...
                            <p class="card-text"><b> Ajoutée par :</b> {{$annonce->user->name}} {{$annonce->user->lastName}}  <a href="{{route('messagerieFirst',$annonce->user->id)}}" >Contacter</a></p>
                            <h4>{{$annonce->prix}} €</h4>
                            ...
                            <hr>
                            <a class="btn btn-success" href="#"> Afficher </a>
