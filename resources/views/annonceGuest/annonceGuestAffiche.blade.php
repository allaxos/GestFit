                ...
                <div class="col-sm-8" >
                    <div class="card" style="padding: 2%;margin: 2% 0%; box-shadow: 5px 5px 10px">
                        <div class="card-body">
                            ...
                            <p><a href="#" class="btn btn-primary" ><i class="fas fa-hand-peace"></i>  réservation </a>  <a class="btn btn-warning" href="{{route('messagerieFirst',$annonce->user->id)}}" >Contacter l'annonceur </a></p>
                            <hr>
